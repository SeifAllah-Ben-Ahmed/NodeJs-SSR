...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VpZmFsbGFoMjAyNCIsImEiOiJja3IzdmdnNmkwYW1yMnFsdHNjeXBnMWZxIn0.IZljnK1M5HEgayYM5yk4fg'; //   'pk.eyJ1Ijoic2VpZi1hbGxhaCIsImEiOiJja3ZqeThpMTEwOTRiMm91Z3k5OGpvM215In0.tOgQH_sNxmE2rjYT9Psz-g';

  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/seifallah2024/ckvjyyajk8xj516s55m4cy5z2',
    scrollZoom: false //   center: [-118.549101, 34.210034],
    //   zoom: 10,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Extend the map bounds
...
var stripe = Stripe('pk_test_51JtYSbKVZxBeLadQBvEwJ6unIfD8L5kfqzZ9SPFzXafoML2RWpX9pj9I2Uo0SY47eNW66Yo4YwaO6kHSqw451dTW003FKJSyo4');
